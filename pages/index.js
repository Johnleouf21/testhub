  ...
  <header className="u-clearfix u-header u-sticky u-sticky-036c" id="sec-c4e9">
    <div className="u-clearfix u-sheet u-valign-top-xs u-sheet-1">
      ...
      >
          ...
          <ul className="u-nav u-unstyled">
            ...
            <li className="u-nav-item">
              <a
                className="u-active-white u-button-style u-hover-custom-color-1 u-nav-link u-text-hover-custom-color-1"
                href="Contact.html"
                style={{ padding: "704px 0px 704px 20px" }}
              >
                Contact
              </a>
            </li>
        ...
        <div className="u-custom-menu u-nav-container-collapse">
          <div
            ...
            data-offcanvas-width={284}
          >
            <div className="u-inner-container-layout u-sidenav-overflow">
              <div className="u-menu-close" />
              <ul className="u-align-center u-nav u-popupmenu-items u-spacing-51 u-text-hover-custom-color-1 u-unstyled u-nav-2">
                <li className="u-nav-item">
      ...
      <div className="u-align-center u-hover-feature u-social-icons u-spacing-11 u-social-icons-1">
        ...
        >
          <span className="u-icon u-social-facebook u-social-icon u-text-black u-icon-1">
            <svg
...
c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"
        ...
        >
          <span className="u-icon u-social-icon u-social-twitter u-text-black u-icon-2">
            <svg
              className="u-svg-link"
              preserveAspectRatio="xMidYMin slice"
              viewBox="0 0 112 112"
...
c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"
        ...
        >
          <span className="u-icon u-social-icon u-social-instagram u-text-black u-icon-3">
            <svg
              className="u-svg-link"
              preserveAspectRatio="xMidYMin slice"
              viewBox="0 0 112 112"
...
c5.5,0,9.9,4.5,9.9,9.9V73.3z"
  ...
  <section
    className="u-clearfix u-image u-valign-middle-xs u-section-1"
    id="sec-47b9"
      ...
      <div className="u-layout">
        <div className="u-layout-row">
          <div className="u-container-style u-layout-cell u-size-25 u-layout-cell-1">
            <div className="u-container-layout u-valign-bottom-xl u-valign-top-lg u-valign-top-sm u-valign-top-xs u-container-layout-1">
              <img
                className="u-align-center u-expanded-width-md u-expanded-width-xl u-image u-image-contain u-image-1"
          ...
          <div className="u-container-style u-layout-cell u-size-25 u-layout-cell-2">
            <div className="u-container-layout u-valign-bottom-lg u-valign-bottom-md u-container-layout-2">
  ...
  <section className="u-clearfix u-section-2" id="sec-3890">
    <div className="u-align-left u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
      <div className="u-container-style u-custom-color-2 u-group u-radius-8 u-shape-round u-group-1">
        <div className="u-container-layout u-container-layout-1">
          <div className="u-align-right u-container-style u-custom-color-1 u-group u-shape-round u-top-right-radius-8 u-group-2">
            <div className="u-container-layout u-container-layout-2">
              <h6 className="u-align-right u-text u-text-1">
                ENDLESS POSSIBILITIES
              </h6>
            </div>
          </div>
          <div className="u-shape u-shape-svg u-text-custom-color-2 u-shape-1">
            <svg
              className="u-svg-link"
  ...
  <section className="u-clearfix u-section-3" id="sec-1081">
        ...
        <div className="u-layout">
          <div className="u-layout-row">
            ...
            <div className="u-size-21-sm u-size-21-xs u-size-40-lg u-size-40-md u-size-40-xl">
              <div className="u-layout-col">
                <div className="u-container-style u-layout-cell u-size-60 u-layout-cell-4">
